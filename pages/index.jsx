...
const PROJECT_NAME = "ab334d52-578f-4a4c-b236-";
...
const IDEA_BRIEF = "Tu es un expert en création de mini-SaaS viraux, ultra rentables, optimisés pour la pub et la scalabilité.\n\nTâche:\n- À partir de la tendance suivante, conçois un mini-SaaS complet.\n\nTendance:\n\"Nom du mini-SaaS : DancePop\nPromesse principale : Transforme ta photo en une vidéo IA où tu danses sur la dernière tendance TikTok en quelques secondes.\nPain point principal : Les utilisateurs veulent créer rapidement des vidéos virales personnalisées sans compétences en montage ou danse.\nFonctionnalités clés :\n- Import facile d’une photo de profil ou selfie\n- Génération automatique de vidéos dansantes s";
